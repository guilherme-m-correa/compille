...
const PainelSolicitante: React.FC = () => {
  ...
  async function handleEndAppointment() {
    try {
      await api.put(
        `${process.env.NEXT_PUBLIC_API_GATEWAY_URL}/comercial/appointments/${appointmentSelected.id}`,
        {
          appointment_status_id: 5
        }
      )

      setModalEndAppointmentOpen(false)
      setAppointments(
        appointments.filter(
  ...
  return (
    <div className="flex flex-col mx-auto">
      ...
      />
      <ModalEndAppointment
        open={modalEndAppointmentOpen}
        setOpen={setModalEndAppointmentOpen}
                      ...
                      >
                        ...
                        <div className="px-4 py-2">
                          <button
                            ...
                            className="primary-btn text-xs tracking-wide"
                          >
                            Ver Detalhes
                          </button>
                        </div>
                      ...
                      >
                        ...
                        <div className="px-4 py-2">
                          <button
                            ...
                            onClick={() => {
                              setAppointmentSelected(appointment)
                              setModalEndAppointmentOpen(true)
                            }}
                            className="primary-btn text-xs tracking-wide"
                          >
                            Finalizar
