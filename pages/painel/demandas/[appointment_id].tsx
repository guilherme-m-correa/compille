          ...
          <div className="hidden lg:block w-1/3 bg-white mr-4 rounded-lg overflow-auto">
            <div className="bg-blue-500 rounded-t-lg">
              ...
              <ul className="px-6 divide-y divide-white">
                <li className="text-white font-medium py-4">
                  Solicitante: {appointment?.requester?.profile_name}
                </li>
                <li className="text-white font-medium py-4">
                  Cidade: {appointment?.forum?.city?.name},{' '}
            ...
            <div className="mt-4 px-6">
              <ul>
                ...
                <li className="text-gray-400 py-2">
                  Local do serviço: {appointment?.forum?.descricao}
                </li>

                <li className="text-gray-400 py-2">
                  Endereço: {appointment?.forum?.address}
                </li>
