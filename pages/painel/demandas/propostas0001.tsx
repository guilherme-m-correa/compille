...
export default function Demanda0001() {
  return (
    <Container>
      <div className="flex justify-center my-10" style={{ height: '80vh' }}>
        <div className="hidden lg:block w-1/5 bg-white mr-4 rounded-lg overflow-auto">
          <div className="bg-blue-500 rounded-t-lg">
            <h3 className="flex p-6 items-center text-xl text-white font-medium py-3">
              Candidatos
            </h3>
          </div>
          ...
          <div>
            <ul className="divide-y-2">
              <li className="flex justify-center hover:bg-gray-200 p-6 ">
                <img
            ...
            <div className="flex justify-center items-center space-x-4">
              <div className="flex">
                <img
                  ...
                  alt=""
                />
                <div className="text-xl flex flex-col text-white font-medium">
                  <h2 className="text-xl text-white font-medium">
                    Guilherme Correa
                  </h2>
                  <span className="text-sm text-white ">OAB/PE 19964</span>
                </div>
              </div>
            </div>
          </div>
